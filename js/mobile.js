...
function setStyle(style)
{
	...
	{
		if (selectableItems[i].innerHTML == _(availableStyles[style]))
		{
...
function getStyleSelection()
{
	for (var style in availableStyles)
		if (availableStyles.hasOwnProperty(style))
			gEBI('styleSelectionBar').innerHTML += '<div class="resultEntry" onclick="setStyle(\''+style+'\')" value="'+style+'">'+_(availableStyles[style])+'</div>';
}
