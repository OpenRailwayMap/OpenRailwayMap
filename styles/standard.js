...
(function (MapCSS) {
    ...
    function restyle(style, tags, zoom, type, selector) {
        ...
        if (((type == 'way' && tags['railway'] == 'rail' && tags['bridge'] == 'yes') && zoom >= 9) || ((type == 'way' && tags['railway'] == 'disused' && tags['bridge'] == 'yes') && zoom >= 9) || ((type == 'way' && tags['railway'] == 'abandoned' && tags['bridge'] == 'yes') && zoom >= 9) || ((type == 'way' && tags['railway'] == 'razed' && tags['bridge'] == 'yes') && zoom >= 9) || ((type == 'way' && tags['railway'] == 'proposed' && tags['bridge'] == 'yes') && zoom >= 9) || ((type == 'way' && tags['railway'] == 'construction' && tags['bridge'] == 'yes') && zoom >= 9) || ((type == 'way' && tags['railway'] == 'preserved' && tags['bridge'] == 'yes') && zoom >= 9) || ((type == 'way' && tags['railway'] == 'narrow_gauge' && tags['bridge'] == 'yes') && zoom >= 9) || ((type == 'way' && tags['railway'] == 'tram' && tags['bridge'] == 'yes') && zoom >= 9) || ((type == 'way' && tags['railway'] == 'subway' && tags['bridge'] == 'yes') && zoom >= 9) || ((type == 'way' && tags['railway'] == 'light_rail' && tags['bridge'] == 'yes') && zoom >= 9)) {
            s_bridges['z-index'] = 1;
        ...
        if (((type == 'way' && tags['railway'] == 'rail' && (!tags.hasOwnProperty('service')) && (!tags.hasOwnProperty('bridge')) && (!tags.hasOwnProperty('tunnel')))) || ((type == 'way' && tags['railway'] == 'disused' && (!tags.hasOwnProperty('service')) && (!tags.hasOwnProperty('bridge')) && (!tags.hasOwnProperty('tunnel')))) || ((type == 'way' && tags['railway'] == 'abandoned' && (!tags.hasOwnProperty('service')) && (!tags.hasOwnProperty('bridge')) && (!tags.hasOwnProperty('tunnel')))) || ((type == 'way' && tags['railway'] == 'razed' && (!tags.hasOwnProperty('service')) && (!tags.hasOwnProperty('bridge')) && (!tags.hasOwnProperty('tunnel')))) || ((type == 'way' && tags['railway'] == 'proposed' && (!tags.hasOwnProperty('service')) && (!tags.hasOwnProperty('bridge')) && (!tags.hasOwnProperty('tunnel')))) || ((type == 'way' && tags['railway'] == 'construction' && (!tags.hasOwnProperty('service')) && (!tags.hasOwnProperty('bridge')) && (!tags.hasOwnProperty('tunnel')))) || ((type == 'way' && tags['railway'] == 'preserved' && (!tags.hasOwnProperty('service')) && (!tags.hasOwnProperty('bridge')) && (!tags.hasOwnProperty('tunnel')))) || ((type == 'way' && tags['railway'] == 'narrow_gauge' && (!tags.hasOwnProperty('service')) && (!tags.hasOwnProperty('bridge')) && (!tags.hasOwnProperty('tunnel')))) || ((type == 'way' && tags['railway'] == 'tram' && (!tags.hasOwnProperty('service')) && (!tags.hasOwnProperty('bridge')) && (!tags.hasOwnProperty('tunnel')))) || ((type == 'way' && tags['railway'] == 'subway' && (!tags.hasOwnProperty('service')) && (!tags.hasOwnProperty('bridge')) && (!tags.hasOwnProperty('tunnel')))) || ((type == 'way' && tags['railway'] == 'light_rail' && (!tags.hasOwnProperty('service')) && (!tags.hasOwnProperty('bridge')) && (!tags.hasOwnProperty('tunnel'))))) {
