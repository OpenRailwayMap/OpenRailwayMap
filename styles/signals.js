...
(function (MapCSS) {
    ...
    function restyle(style, tags, zoom, type, selector) {
        ...
        if (((type == 'node' && tags['railway'] == 'signal' && tags['railway:signal:main'] == 'AT-V2:trapeztafel' && tags['railway:signal:main:form'] == 'sign' && tags['railway:signal:main:function'] == 'entry') && zoom >= 14)) {
            s_default['z-index'] = 1000;
            s_default['text'] = MapCSS.e_localize(tags, 'ref');
            s_default['text-offset'] = 11;
            s_default['text-size'] = '12';
